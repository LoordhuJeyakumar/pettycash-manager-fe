...
function NavBarTop({ setSideNavShow, sideNavShow }) {
  ...
  return (
    <nav
      className="navbar navbar-main navbar-expand-lg px-0 mx-4 border-radius-xl position-sticky mt-4 top-1 z-index-sticky shadow-none shadow-blur"
      id="navbarBlur"
      data-scroll="true"
    >
      <div className="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li className="breadcrumb-item text-sm">
              <Link className="opacity-5 text-white" to={"/dashboard"}>
                Pages
              </Link>
            </li>
            <li
        ...
        >
          <ul className="navbar-nav  justify-content-end">
            ...
            <li className="nav-item px-3">
              <Link className="nav-link p-0 text-body" to={"/profileSettings"}>
            ...
            <li className="nav-item dropdown pe-4">
              ...
              >
                ...
                <span
                  className={`position-absolute top-5 start-100 translate-middle badge rounded-pill  border border-white small py-1 px-2   ${
